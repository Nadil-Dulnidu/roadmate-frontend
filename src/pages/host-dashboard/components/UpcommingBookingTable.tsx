...
export function UpcommingBookingDataTable() {
  ...
  const { isSuccess } = useGetAllBookingByOwnerIdQuery({ token: authToken, ownerId: userId, status: ["CONFIRMED"] }, { skip: !userId || !authToken });
  const bookings = useAppSelector(selectBookingsByOwner(authToken, userId, ["CONFIRMED"]));
    ...
    <div className="flex w-full flex-col justify-start gap-6">
      <div className="flex items-center justify-between px-4 lg:px-6">
        <div className="flex items-center justify-between w-full gap-2">
          <div className="font-semibold text-lg">Upcomming Bookings</div>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
