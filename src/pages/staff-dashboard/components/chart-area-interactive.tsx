...
export function ChartReviewOverview() {
  ...
  const { data = [], error, isLoading } = useGetListingCountByDateQuery({ token: authToken! }, { skip: !authToken });
  ...
  return (
    <Card className="@container/card">
      <CardHeader className="relative">
        ...
        <CardDescription>
          <span className="@[540px]/card:block hidden">Total listing per day</span>
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        <ChartContainer config={chartConfig} className="aspect-auto h-[250px] w-full">
          <AreaChart data={filteredData}>
            ...
            <Area type="monotone" dataKey="listingCount" name="Listing Count" stroke="black" fill="url(#fillReview)" />
          </AreaChart>
        </ChartContainer>
      </CardContent>
    </Card>
